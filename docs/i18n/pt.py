...
<p>A partir da v2.1.1 pode omitir as duas linhas <code>M211</code>: o firmware já permite que o bico desça 3 mm abaixo do zero.</p>
...
<h3>O teste tudo em um</h3>
<p>Barras em balanço, uma ponte, torres de stringing, furos de tolerância e uma escala de finura em uma peça de 65 mm,
cerca de 2 h 30. É o <a href="https://www.thingiverse.com/thing:2656594">All In One 3D printer test</a> de
<strong>majda107</strong> (CC BY 4.0), fatiado para <strong>todas as impressoras</strong> e os dois fatiadores, nos
três materiais. Os arquivos da <a href="{REPO}/releases/latest">versão mais recente</a> se chamam
<code>Test_D9_&lt;model&gt;_&lt;size&gt;_&lt;slicer&gt;_&lt;material&gt;.gcode</code>, por exemplo
