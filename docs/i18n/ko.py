...
<p>v2.1.1부터는 <code>M211</code> 두 줄을 생략해도 됩니다. 펌웨어가 이미 노즐을 0보다 3 mm 아래까지 내릴 수 있게 합니다.</p>
...
<h3>올인원 테스트</h3>
<p>오버행 바, 브리지, 스트링 타워, 공차 구멍, 정밀도 눈금이 65 mm짜리 한 조각에 모두 들어 있고, 약 2시간 30분 걸립니다.
<strong>majda107</strong>의 <a href="https://www.thingiverse.com/thing:2656594">All In One 3D printer test</a>(CC BY 4.0)를
<strong>모든 프린터</strong>와 두 슬라이서, 세 가지 소재에 맞춰 슬라이싱한 것입니다.
<a href="{REPO}/releases/latest">최신 릴리스</a>의 파일 이름은
<code>Test_D9_&lt;model&gt;_&lt;size&gt;_&lt;slicer&gt;_&lt;material&gt;.gcode</code> 형식이며, 예를 들면
<code>Test_D9_MK2_300_Orca_PLA.gcode</code>입니다.</p>
<div class="cards">
