...
<p>Ab v2.1.1 können die beiden <code>M211</code>-Zeilen entfallen: Die Firmware lässt die Düse bereits 3 mm unter null fahren.</p>
...
<h3>Der Alles-in-einem-Test</h3>
<p>Überhangbalken, eine Brücke, Stringing-Türme, Toleranzlöcher und eine Feinheitsskala in einem Teil von 65 mm, etwa
2 h 30 min. Es ist der <a href="https://www.thingiverse.com/thing:2656594">All In One 3D printer test</a> von
<strong>majda107</strong> (CC BY 4.0), für <strong>jeden Drucker</strong> und beide Slicer gesliced, in den drei
Materialien. Die Dateien der <a href="{REPO}/releases/latest">neuesten Version</a> heißen
<code>Test_D9_&lt;model&gt;_&lt;size&gt;_&lt;slicer&gt;_&lt;material&gt;.gcode</code>, zum Beispiel
...
<figure><img src="{img}benchy-petg-dustovich.webp" width="760" height="594" alt="3DBenchy, in PETG auf einer Wanhao D9 gedruckt, von dustovich"><figcaption>PETG · dustovich</figcaption></figure>
</div>
