...
- **The screen's *Information* page shows your model, size and release**, for example *Wanhao D9 MK2 300* and *2.1.x (v2.0.7)*. `M115` reports the same.
...
- **La page *Information* de l'écran affiche votre modèle, votre taille et la version**, par exemple *Wanhao D9 MK2 300* et *2.1.x (v2.0.7)*. `M115` indique la même chose.
